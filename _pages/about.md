...
<div role="alert" style="display: flow-root; border-left: 4px solid #17a2b8; background-color: rgba(23, 162, 184, 0.08); color: var(--global-text-color); padding: 1rem; border-radius: 4px; margin-bottom: 1rem;">
  ...
  <p style="margin-bottom: 0;">
    I am actively recruiting fully funded <strong>PhD students, Postdocs, and Interns</strong> to join our founding team! If you are interested in LLM alignment, AI safety, agentic reasoning, continual learning, or related topics, please reach out.
  </p>
</div>
